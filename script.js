...
<li><strong>Glossy Skeuomorphic UI</strong> — dark brushed-metal tab bar, iOS 6 aesthetic.</li>
        ...
        (function initPullToRefresh() {
            ...
            const scrollableSelectors = ['#geniusContent']; // PTR only on Genius
            ...
            function triggerRefresh(el, ind) {
                ...
                ind.querySelector('.ptr-arrow').innerHTML = '<i class="fas fa-clock-rotate-left fa-spin"></i>';
                setTimeout(() => {
            ...
            function resetIndicator(ind) {
                ...
                setTimeout(() => {
                    ...
                    if (ind.querySelector('.ptr-arrow'))
                        ind.querySelector('.ptr-arrow').innerHTML = '<i class="fas fa-clock-rotate-left"></i>';
                }, 380);
            }
            ...
            // Attach once on DOM ready, then re-check after Genius renders
            patchPTR();
            // Re-run after each render (genius page re-creates its DOM)
            const origRender = window._geniusPtrPatched;
            if (!origRender) {
                window._geniusPtrPatched = true;
                setInterval(patchPTR, 1200);
            }
        })();
