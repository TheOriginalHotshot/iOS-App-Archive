// App data with download URLs and categories
        const apps = [
            ...
            },
            {
                ...
                description: "Brew, pour, and drink beer on your iPad. It's enormous, totally realistic, and even acts as a draught for your iPhone's iBeerâ¢.\n\nThis hilarious visual gag takes full advantage of iPad's omnidirectional nature. There's no wrong way to hold iBeerKegâ¢. It's a stunningly lifelike pool of beer and YOU decide where to 'open' the keg to drink or pour.\n\nTilt for aquarium action, shake for foam and waves, play with condensation, slime and bubbles, even pretend to pour iBeer from iPad to iPhone.\n\nThis isn't just iBeer's big brother on steroids, it's THE interactive liquid simulation for iPad programmed from the ground up by the inventors of iBeer. Gigantic, spectacular, hysterical.\n\nYou've seen it on TV, YouTube, and read about it in your favorite paper. Now it can be yours!\nBonus burp included.\nGet it today and stop those hangovers forever!\n\nJust updated:\nâ FREE steaming coffee: Gallons of it!\nâ MORE DRINKS: Champagne & Wines for the distinguished prankster.\nâ Improved: Trippy Alien Disco Juice, Water, Cola, Milk etc.\nâ Connects to iBeer for iPhone and iPod touch (pending Apple approval)\nâ BlueTooth and WIFI drink sharing among all iOS devices (once iBeer-update for iPhone and iPod touch is approved by Apple). Sharing is caring!\nâ Color mixing when pouring from device to device (mix coffee & beer for a steamy mess)\n\nMAKE YOUR OWN IPHONE APP\nin 2 minutes with AppCat. http://www.app.cat\n\nQuestions and comments? Talk to us!\nWe answer every email and return every call about the world's only keg with full warranty, detailed instructions, video tutorials, and 24/7 support!\n\nHOTTRIXÂ®\n1-877-HOTTRIX\nP. 702-765-4692\nF. 702-643 0777\nhttp://www.hottrixdownload.com\nhelp@hottrix.com\n7500 W Lake Mead Blvd.\nSuite 9-478\nLas Vegas, NV 89128",
                versions: {
                    archived: [
            ...
            },
            {
                ...
                description: "Get the official YouTube app on iPhones and iPads. See what the world is watching -- from the hottest music videos to what's popular in gaming, fashion, beauty, news, learning and more. Subscribe to channels you love, create content of your own, share with friends, and watch on any device.\n\nWatch and subscribe\nâ Browse personal recommendations on Home\nâ See the latest from your favorite channels in Subscriptions\nâ Look up videos you've watched, liked, and saved for later in Library\n\nExplore different topics, what's popular, and on the rise (available in select countries)\nâ Stay up to date on what's popular in music, gaming, beauty, news, learning and more\nâ See what's trending on YouTube and around the world on Explore\nâ Learn about the coolest Creators, Gamers, and Artists on the Rise (available in select countries)\n\nConnect with the YouTube community\nâ Keep up with your favorites creators with Posts, Stories, Premieres, and Live streams\nâ Join the conversation with comments and interact with creators and other community members\n\nCreate content from your mobile device\nâ Create or upload your own videos directly in the app\nâ Engage with your audience in real time with live streaming right from the app\n\nFind the experience that fits you and your family (available in select countries)\nâ Every family has their own approach to online video. Learn about your options: the YouTube Kids app or a new parent supervised experience on YouTube at youtube.com/myfamily\n\nSupport creators you love with channel memberships (available in select countries)\nâ Join channels that offer paid monthly memberships and support their work\nâ Get access to exclusive perks from the channel & become part of their members community\nâ Stand out in comments and live chats with a loyalty badge next to your username\n\nUpgrade to YouTube Premium (available in select countries)\nâ Watch videos uninterrupted by ads, while using other apps, or when the screen is locked\nâ Save videos for when you really need them â like when you're on a plane or commuting\nâ Get access to YouTube Music Premium as part of your benefits\n\nNote: If you subscribe via Apple, payment will be charged to App Store Account at confirmation of purchase. Subscription automatically renews unless auto-renew is turned off at least 24 hours before the end of the current period. Account will be charged for renewal within 24 hours prior to the end of the current period at the rate of the selected plan. Subscriptions and auto-renewal may be managed by going to Account Settings after purchase.\n\nYouTube paid service terms: https://www.youtube.com/t/terms_paidservice.\nPrivacy policy: https://www.google.com/policies/privacy",
                versions: {
                    archived: [
