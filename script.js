...
const cancelSearch = document.querySelector('.cancel-btn');
const searchResults = document.querySelector('.search-results');
const tabs = document.querySelectorAll('.tab');
const tabContents = {
    featured: document.querySelector('.tab-content.featured'),
    search: document.querySelector('.tab-content.search'),
    categories: document.querySelector('.tab-content.categories'),
    genius: document.querySelector('.tab-content.genius'),
    updates: document.querySelector('.tab-content.updates')
};
    ...
    featuredApps.forEach((app, index) => {
        ...
        item.innerHTML = `
            <div class="app-card">
                ...
                <p class="app-description">${app.featuredDescription}</p>
